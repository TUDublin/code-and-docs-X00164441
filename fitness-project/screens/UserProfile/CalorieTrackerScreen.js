...
const CalorieTrackerScreen = () => {
  ...
  return (
    <View style={styles(isDarkMode).container}>
      ...
      />
      <TouchableOpacity
        style={styles(isDarkMode).searchButton}
        onPress={fetchNutritionData}
      >
        <Text style={styles(isDarkMode).buttonText}>Search</Text>
      </TouchableOpacity>
      <TouchableOpacity
        style={styles(isDarkMode).viewButton}
        onPress={() => setModalVisible(true)}
      >
        <Text style={styles(isDarkMode).buttonText}>View Today's Calories</Text>
      </TouchableOpacity>
      <FlatList
        data={foodData}
